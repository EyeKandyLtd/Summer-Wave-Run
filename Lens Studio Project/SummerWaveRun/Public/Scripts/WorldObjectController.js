...
var worldTrackingResetEvent;

Init();

function Init() {

     //worldTrackingResetEvent = script.createEvent("WorldTrackingResetEvent");

    if (!script || script.getSceneObject() == null) return;
    ...
    if (script.touchCollisionMaterial) {
        ...
        //print("setting of baseColour of touch collision is : " + script.touchCollisionMaterial.mainPass.baseColor.ToString());
    }
